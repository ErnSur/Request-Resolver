...
namespace UIElementsExamples
{
    public class E20_DragAndDrop : EditorWindow
    {
        ...
        {
            var window = GetWindow<E20_DragAndDrop>();
        ...
        void OnDragUpdatedEvent(DragUpdatedEvent e)
        {
            ...
            var draggedLabel = DragAndDrop.GetGenericData(DraggableLabel.s_DragDataType);
        ...
        void OnDragPerformEvent(DragPerformEvent e)
        {
            ...
            var draggedObject = DragAndDrop.GetGenericData(DraggableLabel.s_DragDataType);
